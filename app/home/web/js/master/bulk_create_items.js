$(document).ready(function() {
    const expectedColumns = [
        "Country", "Item Category", "Sub Category", "Organization Code", "Item Name", 
        "Item Description", "Brand", "Molecule", "Variant", "Form", 
        "Special Material Flag", "Primary UOM", "Secondary UOM", "List Price", 
        "Invoice Enabled", "Drug Schedule", "Lot Divisible", "VAT %", "DCC Code", 
        "Supplier", "Barcode Pack size", "Barcode MRP", "Comments"
    ];
