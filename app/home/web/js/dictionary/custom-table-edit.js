var jsonData = [
    { "name": "A", "value": "Cipla" },
    { "name": "B", "value": "Dr Reddy" },
    { "name": "C", "value": "Sun Pharma" }
];
...
function renderTable(data, append = false) {
    ...
    $.each(data, function(index, item) {
        ...
        if (name.trim() !== "" && value.trim() !== "") {
            tbody.append(`
                <tr>
                    <td><span class="nameText">${name}</span><input class="nameInput form-control form-control-sm" type="text" value="${name}" style="display:none;"></td>
                    ...
                    <td>
                        <div class="d-flex">
                            <button class="btn btn-xs btn-primary editBtn mg-r-10"><i class="fa fa-pencil"></i> Edit</button>
...
$(document).ready(function() {
    ...
    $('#addRowBtn').click(function() {
        $('#editableTable tbody').prepend(`
            <tr>
                <td class="highlight"><span class="nameText"></span><input class="nameInput form-control form-control-sm" type="text" value=""></td>
                ...
                <td class="highlight">
                    <div class="d-flex">
                        ...
                        <button class="btn btn-xs btn-success saveBtn mg-r-10"><i class="fa fa-save"></i> Save</button>
                        <button class="btn btn-xs btn-danger deleteBtn"><i class="fa fa-trash"></i> Delete</button>
                    </div>
