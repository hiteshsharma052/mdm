!function($, wysi) {
    ...
    var tpl = {
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-link-modal modal fade' id='linkmodal' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>" +
                ...
                "<div class='modal-body'>" +
                  "<label>Link</label><input class='bootstrap-wysihtml5-insert-link-url m-wrap large form-control' type='text' placeholder='https://'>" +
                "</div>" +
                "<div class='modal-footer'>" +
                  "<a href='#' class='btn btn-white' data-bs-dismiss='modal'>" + locale.link.cancel + "</a>" +
                  "<a href='#' class='btn green  btn-primary' data-bs-dismiss='modal'>" + locale.link.insert + "</a>" +
                "</div>" +
              "</div></div></div>" +
              "<a style='display:None' class='btn btn-white" + size + "' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' data-toggle='modal' data-target='#linkmodal'><i class='fa fa-link'></i></a>" +
            "</li>";
        },
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-modal modal fade' id='imgmodal' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>" +
                ...
                "</div>" +
                "<div class='modal-body'>" +
                    "<label>Enter Image URL</label><input value='http://' class='form-control bootstrap-wysihtml5-insert-image-url m-wrap large' type='text'>" +
                "</div>" +
                "<div class='modal-footer'>" +
                ...
                "</div>" +
             "</div></div></div>" +
              "<a style='display:None' class='btn btn-white" + size + "' data-wysihtml5-command='insertImage' title='" + locale.image.insert + "' data-toggle='modal' data-target='#imgmodal'><i class='fa fa-picture-o'></i></a>" +
            "</li>";
        },
        ...
        "html": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div class='btn-group daas_tooltip_font_style'>" + 
                "<a class='btn btn-white" + size + "' data-wysihtml5-action='change_view' title='" + locale.html.edit + "'><i class='fa fa-pencil'></i></a>" +
              "</div>" +
            "</li>";
        },
        ...
        "color": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li class='dropdown daas_tooltip_color'>" +
              "<a class='btn dropdown-toggle btn-white" + size + "' data-toggle='dropdown' href='#'>" +
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["/common/web/plugins/bootstrap-wysihtml5/wysiwyg-color.css"], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "en"
    };
